    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CategoryTranslation>().HasData(
                  ...
                  new CategoryTranslation() { Id = 5, CategoryId = 3, Name = "Đồ công nghệ", LanguageId = "vi", SeoAlias = "do-cong-nghe", SeoDescription = "Sản phẩm công nghệ", SeoTitle = "Sản phẩm công nghệ" },
                  new CategoryTranslation() { Id = 6, CategoryId = 3, Name = "Technological", LanguageId = "en", SeoAlias = "technological", SeoDescription = "technological", SeoTitle = "technological" },
                  new CategoryTranslation() { Id = 7, CategoryId = 4, Name = "Hàng tiêu dùng", LanguageId = "vi", SeoAlias = "hang-tieu-dung", SeoDescription = "Sản phẩm áo tiêu dùng", SeoTitle = "Sản phẩm áo tiêu dùng" },
                  new CategoryTranslation() { Id = 8, CategoryId = 4, Name = "Consumer goods", LanguageId = "en", SeoAlias = "consumer-goods", SeoDescription = "consumer-goods", SeoTitle = "consumer-goods" }
                    );
           ...
           new Product()
           {
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                Email = "haipnn@gmail.com",
                NormalizedEmail = "haipnn@gmail.com",
                EmailConfirmed = true,
